...
clear all
format long
alpha=4;% aspect ratio a3=a,a3/a2=beta,a3/a1=alpha
...
%%
fileID = fopen('general_ellipsoid_PVDF_PZT_x1_axis_as2.xls','w');
...
fileid2=fopen('ellipsoid_x1_as2_PVDF_PZT_extra_properties.xls','w');
