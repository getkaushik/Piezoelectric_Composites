...
vf_length=len(vf)
mesh_size = 6
file=open('Result_multiparticle_mixed_AR_ESO_BT_E33.txt','w')
...
#        mask=('[#7 ]', ), )), stackDirection=STACK_3)
    ...
    JobName = 'multiparticle_RVE_ESO_BT_E33_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-E33'
