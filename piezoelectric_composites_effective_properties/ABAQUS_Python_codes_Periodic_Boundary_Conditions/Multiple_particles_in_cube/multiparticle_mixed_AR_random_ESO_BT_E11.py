...
vf_length=len(vf)
mesh_size = 6
file=open('Result_multiparticle_mixed_AR_ESO_BT_E11.txt','w')
...
#        mask=('[#7 ]', ), )), stackDirection=STACK_3)
    ...
    JobName = 'multiparticle_RVE_ESO_BT_E11_'+ nn
...
##            f2.write('%d\t %6.8f\n' %(v_strain.elementLabel,v_strain.data[3]))
    ...
    f3=open('Electric_Displacement_BC_E11_volFrac_'+nn+'.txt','w')
...
#   f4=open('Electric_Potential_Gradient_BC_E11_volFrac_'+nn+'.txt','w')
