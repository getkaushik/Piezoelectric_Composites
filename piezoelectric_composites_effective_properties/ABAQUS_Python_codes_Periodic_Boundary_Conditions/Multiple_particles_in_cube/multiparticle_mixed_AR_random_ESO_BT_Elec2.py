...
cwd = os.getcwd()
vf = numpy.arange(0.001125,0.034,0.001125)
vf_length=len(vf)
mesh_size = 6
file=open('Result_multiparticle_mixed_AR_ESO_BT_Elec2.txt','w')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):
   ...
   #AR_1.0 
    ...
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-1', ), vector=(23.19,26.42,27.63))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-1',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-2', ), vector=(-24.3184,-23.6081,27.9699))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-2',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-3', ), vector=(-25.0,-23.1,-27.50))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-3',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-4', ), vector=(0.5702,-0.11803,-1.8764))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-4',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-5', ), vector=(-25.394,27.2484,-21.9012))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-5',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-6', ), vector=(25.5107,-27.62,-22.24))  
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-6',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0)
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-7', ), vector=(20.19,-26.42,24.63))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-7',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0) 
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-8', ), vector=(25.0,26.32,-26.24))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-8',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0)     
    a1 = mdb.models[ModelName].rootAssembly 
    a1.translate(instanceList=('Reinforcement-9', ), vector=(-24.93184,24.1081,22.8096))
    a = mdb.models[ModelName].rootAssembly
    a.rotate(instanceList=('Reinforcement-9',), axisPoint=(0.0, 0.0, 0.0), axisDirection=(0.0, 1.0, 0.0), angle=90.0)
...
#        mask=('[#7 ]', ), )), stackDirection=STACK_3)
    ...
    mdb.models[ModelName].ElectricPotentialBC(name='BC-ELEC1', createStepName='Step-1', region=region, fixed=OFF, 
            distributionType=UNIFORM, fieldName='', magnitude=0, amplitude=UNSET)
    ...
    JobName = 'multiparticle_RVE_ESO_BT_Elec2_'+ nn
