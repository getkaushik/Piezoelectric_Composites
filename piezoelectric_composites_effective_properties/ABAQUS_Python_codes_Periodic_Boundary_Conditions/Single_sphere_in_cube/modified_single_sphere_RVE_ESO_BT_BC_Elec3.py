...
file.write('vol_frac\t e31\t e32\t e33\t e34\t e53\t e36\t rel_k13\t rel_k23\t rel_k33 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # e_0 = Dielectric constant of vaccum    
    ...
    #create sections
    mdb.models['Model-'+str(jjj)].HomogeneousSolidSection(material='ESO', name=
        'Matrixsection', thickness=None)
    mdb.models['Model-'+str(jjj)].HomogeneousSolidSection(material='BT', name=
    ...
    # Saved by KABIR BAIDYA on 09/03/2022
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Elec3_'+ nn
...
##    f1.write('Elements\t Stress11\t Stress22\t Stress33 \n')    
    vol_stress11=0
    vol_stress22=0
    vol_stress33=0
    vol_stress12=0
...
##            f1.write('%d\t %12.8f \t %12.8f \t %12.8f \n' %(v_stress.elementLabel,v_stress.data[0],v_stress.data[1],v_stress.data[2]))
...
##            f3.write('%d\t %20.20f  \n' %(v_elec_disp.elementLabel,v_elec_disp.data[2]))
...
##            f4.write('%d\t %20.20f \n' %(v_elec_pot_grad.elementLabel,v_elec_pot_grad.data[2]))
    ...
    e34=-avg_stress23/avg_elec_pot_grad3
    e35=-avg_stress13/avg_elec_pot_grad3
    e36=-avg_stress12/avg_elec_pot_grad3
    k13=avg_elec_disp1/avg_elec_pot_grad3    
    rel_k13=k13/e_0
    k23=avg_elec_disp2/avg_elec_pot_grad3    
    rel_k23=k23/e_0
    k33=avg_elec_disp3/avg_elec_pot_grad3    
    rel_k33=k33/e_0
    
     
    file.write('%4.5f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t  %20.20f\n '%(vol_frac,e31,e32,e33,e34,e35,e36,rel_k13,rel_k23,rel_k33))
