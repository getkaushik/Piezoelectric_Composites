...
file.write('vol_frac\t e21\t e22\t e23\t e24\t e25\t e26\t rel_k12\t rel_k22\t rel_k32\n')
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Elec2_'+ nn
...
##            f1.write('%d\t %20.20f\n' %(v_stress.elementLabel,v_stress.data[5]))
...
##            f3.write('%d\t %20.20f \n' %(v_elec_disp.elementLabel,v_elec_disp.data[1]))
...
##            f4.write('%d\t %20.20f \n' %(v_elec_pot_grad.elementLabel,v_elec_pot_grad.data[1]))
    ...
    e21=-avg_stress11/avg_elec_pot_grad2
    e22=-avg_stress22/avg_elec_pot_grad2
    e23=-avg_stress33/avg_elec_pot_grad2
    e24=-avg_stress23/avg_elec_pot_grad2
    e25=-avg_stress13/avg_elec_pot_grad2
    e26=-avg_stress12/avg_elec_pot_grad2
    k12=avg_elec_disp1/avg_elec_pot_grad2    
    rel_k12=k12/e_0
    k22=avg_elec_disp2/avg_elec_pot_grad2  
    rel_k22=k22/e_0
    k32=avg_elec_disp3/avg_elec_pot_grad2    
    rel_k32=k32/e_0

    
    
    file.write('%4.5f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \n '%(vol_frac,e21,e22,e23,e24,e25,e26,rel_k12,rel_k22,rel_k32))
