...
file.write('vol_frac\t C51\t C52\t C53\t C54\t C55\t C56\t e15\t e25\t e35 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Saved by KABIR BAIDYA on 07/04/2022
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Gamma13_'+ nn
...
##            f2.write('%d\t %6.8f\n' %(v_strain.elementLabel,v_strain.data[4]))
...
#    f4.close()
    ...
    e15=avg_elec_disp1/avg_strain13
    e25=avg_elec_disp2/avg_strain13
    e35=avg_elec_disp3/avg_strain13

    
    
    file.write('%4.5f \t %20.5f \t %20.5f \t%20.5f \t%20.5f \t%20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C51,C52,C53,C54,C55,C56,e15,e25,e35))
