...
file.write('vol_frac\t e11\t e12\t e13\t e14\t e15\t e16\t rel_k11\t rel_k21\t rel_k31\n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Saved by KABIR BAIDYA 09/03/2022
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Elec1_'+ nn
...
##            f1.write('%d\t %12.8f \n' %(v_stress.elementLabel,v_stress.data[4]))
...
##    f3.write('Elements\t D1 \n')
    ...
    for i in range(len(elementVolumevalues)):
        ...
        for v_elec_disp in fieldValues:
            ...
            #f3.write('%d\t %20.20f  \n' %(v_elec_disp.elementLabel,v_elec_disp.data[0]))
...
##            f4.write('%d\t %20.20f \n' %(v_elec_pot_grad.elementLabel,v_elec_pot_grad.data[0]))
    ...
    e11=-avg_stress11/avg_elec_pot_grad1
    e12=-avg_stress22/avg_elec_pot_grad1
    e13=-avg_stress33/avg_elec_pot_grad1
    e14=-avg_stress23/avg_elec_pot_grad1
    e15=-avg_stress13/avg_elec_pot_grad1
    e16=-avg_stress12/avg_elec_pot_grad1
    k11=avg_elec_disp1/avg_elec_pot_grad1    
    rel_k11=k11/e_0
    k21=avg_elec_disp2/avg_elec_pot_grad1    
    rel_k21=k21/e_0
    k31=avg_elec_disp3/avg_elec_pot_grad1    
    rel_k31=k31/e_0
    

    
    
    file.write('%4.5f \t  %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t %20.20f \t  %20.20f\n '%(vol_frac,e11,e12,e13,e14,e15,e16,rel_k11,rel_k21,rel_k31))
