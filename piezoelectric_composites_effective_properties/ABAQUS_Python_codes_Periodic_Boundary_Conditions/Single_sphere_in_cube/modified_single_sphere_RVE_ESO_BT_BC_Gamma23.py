...
file.write('vol_frac\t C41\t C42\t C43\t C44\t C45\t C46\t e14\t e24\t e34 \n')
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Gamma23_'+ nn
...
#    f4.close()
    ...
    e14=avg_elec_disp1/avg_strain23
    e24=avg_elec_disp2/avg_strain23
    e34=avg_elec_disp3/avg_strain23

    
    
    file.write('%4.5f \t %20.5f \t %20.5f \t%20.5f \t%20.5f \t%20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C41,C42,C43,C44,C45,C46,e14,e24,e34))
