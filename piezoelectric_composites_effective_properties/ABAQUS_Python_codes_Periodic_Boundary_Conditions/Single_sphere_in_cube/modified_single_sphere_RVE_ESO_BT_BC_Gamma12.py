...
file.write('vol_frac\t C61\t C62\t C63\t C64\t C65\t C66\t e16\t e26\t e36 \n')
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_Gamma12_'+ nn
...
#   f4.close()
    ...
    e16=avg_elec_disp1/avg_strain12
    e26=avg_elec_disp2/avg_strain12
    e36=avg_elec_disp3/avg_strain12

    
    
    file.write('%4.5f \t %20.5f \t %20.5f \t %20.5f \t %20.5f \t %20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C61,C62,C63,C64,C65,C66,e16,e26,e36))
