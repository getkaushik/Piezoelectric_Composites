...
file.write('vol_frac\t C31\t C32\t C33\t C34\t C35\t C36\t e13\t e23\t e33 \n')
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_E33_'+ nn
...
##            f2.write('%d\t %6.8f\n' %(v_strain.elementLabel,v_strain.data[2]))
...
#    f4.close()
    ...
    e13=avg_elec_disp1/avg_strain33
    e23=avg_elec_disp2/avg_strain33
    e33=avg_elec_disp3/avg_strain33

    
    
    file.write('%4.5f \t  %12.8f \t %12.8f \t%12.8f \t %12.8f \t %12.8f \t%12.8f \t%12.8f \t %12.8f \t  %12.8f\n '%(vol_frac,C31,C32,C33,C34,C35,C36,e13,e23,e33))
