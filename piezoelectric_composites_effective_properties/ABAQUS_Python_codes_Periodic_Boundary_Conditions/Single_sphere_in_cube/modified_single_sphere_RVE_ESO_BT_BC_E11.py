...
file.write('vol_frac\t C11\t C12\t C13\t C14\t C15\t C16\t e11\t e21\t e31\n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Reinforcement: Barium Titanate (BT or BTO) {Transversely Isotropic}
...
#    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_sphere_RVE_ESO_BT_BC_E11_'+ nn
...
#    f4.close()
    ...
    e11=avg_elec_disp1/avg_strain11
    e21=avg_elec_disp2/avg_strain11
    e31=avg_elec_disp3/avg_strain11
    
    
    file.write('%4.5f \t %12.8f \t %12.8f \t%12.8f \t %12.8f \t %12.8f \t %12.8f \t %12.8f \t %12.8f \t %12.8f\n '%(vol_frac,C11,C12,C13,C14,C15,C16,e11,e21,e31))
