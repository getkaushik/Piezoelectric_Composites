...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_E33_ellipsoid_interphase50nm.txt','w')
...
##    mdb.models[ModelName].ElectricPotentialBC(name='BC-centre-elec', createStepName='Step-1', region=region, fixed=OFF, distributionType=UNIFORM, fieldName='', magnitude=0.0, amplitude=UNSET)
    ...
    JobName = 'single_ellipsoid_ESO_PANI_BT_BC_E33_interphase_thickness_50nm'+ nn
    ...
    f1=open('Stress_BC_E33_Interphase_Thickness_50nm'+nn+'.txt','w')
