...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Gamma23_sphere.txt','w')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Gamma23
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Gamma23_'+ nn
