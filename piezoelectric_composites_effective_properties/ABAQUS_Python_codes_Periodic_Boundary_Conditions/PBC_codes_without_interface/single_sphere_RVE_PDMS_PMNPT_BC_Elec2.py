...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Elec2_sphere.txt','w')
file.write('vol_frac\t  e24\t rel_k22\n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Elec2
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Elec2_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-Elec2'
    ...
    f1=open('Stress_BC_Elec2_volFrac_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_Elec2_volFrac_'+nn+'.txt','w')
    ...
    f3=open('Electric_Displacement_BC_Elec2_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_Elec2_volFrac_'+nn+'.txt','w')
    ...
    k22=avg_elec_disp2/avg_elec_pot_grad2
    relative_k22=k22/(8.85418782*10**-12)
    e24=-avg_stress23/avg_elec_pot_grad2

    
    
    file.write('%4.5f \t %20.20f \t %20.20f\n '%(vol_frac,e24,relative_k22))
