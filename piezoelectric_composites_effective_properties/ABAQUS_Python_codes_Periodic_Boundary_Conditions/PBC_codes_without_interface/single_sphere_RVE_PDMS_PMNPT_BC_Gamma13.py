...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Gamma13_sphere.txt','w')
file.write('vol_frac\t C51\t C52\t C53\t C54\t C55\t C56 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Gamma13
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Gamma13_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-Gamma13'
    ...
    f1=open('Stress_BC_Gamma13_volFrac_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_Gamma13_volFrac_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f3=open('Electric_Displacement_BC_Gamma13_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_Gamma13_volFrac_'+nn+'.txt','w')
    ...
    C51=avg_stress11/avg_strain13
    C52=avg_stress22/avg_strain13
    C53=avg_stress33/avg_strain13
    C54=avg_stress23/avg_strain13
    C55=avg_stress13/avg_strain13
    C56=avg_stress12/avg_strain13

    
    
    file.write('%4.5f \t %20.5f \t %20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C51,C52,C53,C54,C55,C56))
