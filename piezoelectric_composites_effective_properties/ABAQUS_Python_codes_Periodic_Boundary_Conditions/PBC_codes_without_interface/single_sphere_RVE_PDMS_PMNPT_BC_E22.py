...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_E22_sphere.txt','w')
file.write('vol_frac\t  C21\t C22\t C23\t C24\t C25\t C26 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-E22
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_E22_'+ nn
    ...
    f1=open('Stress_BC_E22_volFrac_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_E22_volFrac_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f3=open('Electric_Displacement_BC22_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_E22_volFrac_'+nn+'.txt','w')
