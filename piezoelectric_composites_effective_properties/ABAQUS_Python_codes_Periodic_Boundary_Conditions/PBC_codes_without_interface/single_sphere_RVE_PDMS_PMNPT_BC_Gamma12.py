...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Gamma12_sphere.txt','w')
file.write('vol_frac\t  C61\t C62\t C63\t C64\t C65\t C66 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Gamma12
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Gamma12_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-Gamma12'
    ...
    f1=open('Stress_BC_Gamma12_volFrac_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_Gamma12_volFrac_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f3=open('Electric_Displacement_BC_Gamma12_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_Gamma12_volFrac_'+nn+'.txt','w')
    ...
    C61=avg_stress11/avg_strain12
    C62=avg_stress22/avg_strain12
    C63=avg_stress33/avg_strain12
    C64=avg_stress23/avg_strain12
    C65=avg_stress13/avg_strain12
    C66=avg_stress12/avg_strain12

    
    
    file.write('%4.5f \t   %20.5f \t %20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C61,C62,C63,C64,C65,C66))
