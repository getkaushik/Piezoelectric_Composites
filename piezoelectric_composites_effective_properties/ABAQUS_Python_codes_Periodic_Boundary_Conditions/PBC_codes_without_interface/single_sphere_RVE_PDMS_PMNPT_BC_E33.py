...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_E33_sphere.txt','w')
file.write('vol_frac\t C31\t C32\t C33\t C34\t C35\t C36 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-E33
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_E33_'+ nn
   ...
   # print 'average strain22=' , avg_strain22
    ...
    C31=avg_stress11/avg_strain33
    C32=avg_stress22/avg_strain33
    C33=avg_stress33/avg_strain33
    C34=avg_stress23/avg_strain33
    C35=avg_stress13/avg_strain33
    C36=avg_stress12/avg_strain33

    
    
    file.write('%4.5f \t  %20.5f \t %20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,C31,C32,C33,C34,C35,C36))
