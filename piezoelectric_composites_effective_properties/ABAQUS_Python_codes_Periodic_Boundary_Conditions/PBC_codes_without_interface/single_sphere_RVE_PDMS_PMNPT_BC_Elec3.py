...
cwd = os.getcwd()
vf=numpy.arange(0.02,0.42,0.02)
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Elec3_sphere.txt','w')
file.write('vol_frac\t e31\t e32\t e33\t rel_k33\n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    radius=((RVEvolume*vol_frac*3)/(4*(22/7)))**(1.0/3.0)
    nnn = str(vol_frac)
    nn = nnn[2:]
    ...
    #Depth = 80
    cen = 0
    mdb.models['Model-'+str(jjj)].ConstrainedSketch(name='__profile__', sheetSize=200.0)
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].rectangle(point1=(50.0, -50.0), 
        point2=(-50.0, 50.0))
    mdb.models['Model-'+str(jjj)].Part(dimensionality=THREE_D, name='Part-1', type=
        DEFORMABLE_BODY)
    mdb.models['Model-'+str(jjj)].parts['Part-1'].BaseSolidExtrude(depth=100.0, sketch=
        mdb.models['Model-'+str(jjj)].sketches['__profile__'])
    del mdb.models['Model-'+str(jjj)].sketches['__profile__']
    mdb.models['Model-'+str(jjj)].ConstrainedSketch(name='__profile__', sheetSize=200.0)
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].ArcByCenterEnds(center=(0.0, 0.0)
        , direction=CLOCKWISE, point1=(0.0, 50.0), point2=(0.0, -50.0))
    del mdb.models['Model-'+str(jjj)].sketches['__profile__']
    mdb.models['Model-'+str(jjj)].ConstrainedSketch(name='__profile__', sheetSize=200.0)
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].ArcByCenterEnds(center=(0.0, 0.0)
        , direction=CLOCKWISE, point1=(0.0, radius), point2=(0.0, -radius))
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].Line(point1=(0.0, -radius), point2=
        (0.0, radius))
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].VerticalConstraint(addUndoState=
        False, entity=mdb.models['Model-'+str(jjj)].sketches['__profile__'].geometry[3])
    del mdb.models['Model-'+str(jjj)].sketches['__profile__']
    mdb.models['Model-'+str(jjj)].ConstrainedSketch(name='__profile__', sheetSize=200.0)
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].ConstructionLine(point1=(0.0, 
        -100.0), point2=(0.0, 100.0))
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].FixedConstraint(entity=
        mdb.models['Model-'+str(jjj)].sketches['__profile__'].geometry[2])
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].ArcByCenterEnds(center=(0.0, 0.0)
        , direction=CLOCKWISE, point1=(0.0, radius), point2=(0.0, -radius))
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].Line(point1=(0.0, -radius), point2=
        (0.0, radius))
    mdb.models['Model-'+str(jjj)].sketches['__profile__'].VerticalConstraint(addUndoState=
        False, entity=mdb.models['Model-'+str(jjj)].sketches['__profile__'].geometry[4])
    mdb.models['Model-'+str(jjj)].Part(dimensionality=THREE_D, name='Part-2', type=
        DEFORMABLE_BODY)
    mdb.models['Model-'+str(jjj)].parts['Part-2'].BaseSolidRevolve(angle=360.0, 
        flipRevolveDirection=OFF, sketch=
        mdb.models['Model-'+str(jjj)].sketches['__profile__'])
    del mdb.models['Model-'+str(jjj)].sketches['__profile__']

    #material properties PDMS
    # Stiffness Matrix of matrix in the absence of applied electric field
    
    C_m11 = 2.45*(10**6) # Units Pa
    C_m12 = 8.16*(10**5) # Units Pa
    C_m13 = 8.16*(10**5) # Units Pa
    C_m14 = 0 # Units Pa
    C_m15 = 0 # Units Pa
    C_m16 = 0 # Units Pa
    C_m22 = 2.45*(10**6) # Units Pa
    C_m23 = 8.16*(10**5) # Units Pa
    C_m24 = 0 # Units Pa
    C_m25 = 0 # Units Pa
    C_m26 = 0 # Units Pa
    C_m33 = 2.45*(10**6) # Units Pa
    C_m34 = 0 # Units Pa
    C_m35 = 0 # Units Pa
    C_m36 = 0 # Units Pa
    C_m44 = 1.63*(10**6) # Units Pa
    C_m45 = 0 # Units Pa
    C_m46 = 0 # Units Pa
    C_m55 = 1.63*(10**6) # Units Pa
    C_m56 = 0 # Units Pa
    C_m66 = 1.63*(10**6) # Units Pa
    ...
    K_m11 = 2.124*(10**(-11)) # Units F/m
    K_m12 = 0 # Units C/(V.m)
    K_m13 = 0 # Units C/(V.m)
    K_m22 = 2.124*(10**(-11))# Units F/m
    K_m23 = 0 # Units C/(V.m)
    K_m33 = 2.124*(10**(-11)) # Units F/m

    # Reinforcement: PMNPT {Transversely Isotropic}
    # Stiffness Matrix of Reinforcement in the absence of applied electric field
    C_f11 = 13.8*(10**10) # Units Pa
    C_f12 = 8.5*(10**10) # Units Pa
    C_f13 = 8.4*(10**10) # Units Pa
    C_f14 = 0 # Units Pa
    C_f15 = 0 # Units Pa
    C_f16 = 0 # Units Pa
    C_f22 = 13.8*(10**10) # Units Pa
    C_f23 = 8.4*(10**10) # Units Pa
    C_f24 = 0 # Units Pa
    C_f25 = 0 # Units Pa
    C_f26 = 0 # Units Pa
    C_f33 = 12.2*(10**10) # Units Pa
    C_f34 = 0 # Units Pa
    C_f35 = 0 # Units Pa
    C_f36 = 0 # Units Pa
    C_f44 = 2.14*(10**10) # Units Pa
    C_f45 = 0 # Units Pa
    C_f46 = 0 # Units Pa
    C_f55 = 2.14*(10**10) # Units Pa
    C_f56 = 0 # Units Pa
    C_f66 = 2.65*(10**10) # Units Pa
    # Piezoelectric stress-coefficient matrix of reinforcement
    e_f11 = 0 # Units C/(m**2)
    e_f12 = 0 # Units C/(m**2)
    e_f13 = 0 # Units C/(m**2)
    e_f14 = 0 # Units C/(m**2)
    e_f15 = 23.2 # Units C/(m**2)
    e_f16 = 0 # Units C/(m**2)
    e_f21 = 0 # Units C/(m**2)
    e_f22 = 0 # Units C/(m**2)
    e_f23 = 0 # Units C/(m**2)
    e_f24 = 23.2 # Units C/(m**2)
    e_f25 = 0 # Units C/(m**2)
    e_f26 = 0 # Units C/(m**2)
    e_f31 = -20.8 # Units C/(m**2)
    e_f32 = -20.8 # Units C/(m**2)
    e_f33 = 30.9 # Units C/(m**2)
    e_f34 = 0 # Units C/(m**2)
    e_f35 = 0 # Units C/(m**2)
    e_f36 = 0 # Units C/(m**2)
    # Dielectric matrix of reinforcement
    K_f11 = 2810*(8.85418782*10**(-12)) # Units F/m
    K_f12 = 0 # Units C/(V.m)
    K_f13 = 0 # Units C/(V.m)
    K_f22 = 2810*(8.85418782*10**(-12)) # Units F/m
    K_f23 = 0 # Units C/(V.m)
    K_f33 = 2330*(8.85418782*10**(-12)) # Units F/m
    
    session.viewports['Viewport: 1'].partDisplay.setValues(sectionAssignments=ON, 
        engineeringFeatures=ON)
    session.viewports['Viewport: 1'].partDisplay.geometryOptions.setValues(
        referenceRepresentation=OFF)
    mdb.models['Model-'+str(jjj)].Material(name='PDMS')
    mdb.models['Model-'+str(jjj)].materials['PDMS'].Piezoelectric(table=((e_m11, e_m12, e_m13, e_m16, e_m15, e_m14, e_m21, e_m22, e_m23, e_m26, e_m25, e_m24, e_m31, e_m32, e_m33, e_m36, e_m35, e_m34), ))
    mdb.models['Model-'+str(jjj)].materials['PDMS'].Elastic(type=ANISOTROPIC, table=((C_m11, C_m12, C_m22, C_m13, C_m23, C_m33, C_m16, C_m26, C_m36, C_m66, C_f15, C_f25, C_m35, C_m56, C_m55, C_m14, C_m24, C_m34, C_m46, C_m45, C_m44), ))
    mdb.models['Model-'+str(jjj)].materials['PDMS'].Dielectric(type=ANISOTROPIC, table=((K_m11, K_m12, K_m22, K_m13, K_m23, K_m33), ))
    mdb.models['Model-'+str(jjj)].Material(name='PMNPT')
    mdb.models['Model-'+str(jjj)].materials['PMNPT'].Piezoelectric(table=((e_f11, e_f12, e_f13, e_f16, e_f15, e_f14, e_f21, e_f22, e_f23, e_f26, e_f25, e_f24, e_f31, e_f32, e_f33, e_f36, e_f35, e_f34), ))
    mdb.models['Model-'+str(jjj)].materials['PMNPT'].Elastic(type=ANISOTROPIC, table=((C_f11, C_f12, C_f22, C_f13, C_f23, C_f33, C_f16, C_f26, C_f36, C_f66, C_f15, C_f25, C_f35, C_f56, C_f55, C_f14, C_f24, C_f34, C_f46, C_f45, C_f44), ))
    mdb.models['Model-'+str(jjj)].materials['PMNPT'].Dielectric(type=ANISOTROPIC,table=((K_f11, K_f12, K_f22, K_f13, K_f23, K_f33), ))
    #-------------------------------------------------------------------------------

    #create sections
    mdb.models['Model-'+str(jjj)].HomogeneousSolidSection(material='PDMS', name=
        'Matrixsection', thickness=None)
    mdb.models['Model-'+str(jjj)].HomogeneousSolidSection(material='PMNPT', name=
        'Fibersection', thickness=None)
    mdb.models['Model-'+str(jjj)].rootAssembly.DatumCsysByDefault(CARTESIAN)
    mdb.models['Model-'+str(jjj)].rootAssembly.Instance(dependent=OFF, name='Part-1-1', 
        part=mdb.models['Model-'+str(jjj)].parts['Part-1'])
    mdb.models['Model-'+str(jjj)].rootAssembly.Instance(dependent=OFF, name='Part-2-1', 
        part=mdb.models['Model-'+str(jjj)].parts['Part-2'])
    mdb.models['Model-'+str(jjj)].rootAssembly.translate(instanceList=('Part-1-1', ), 
        vector=(0.0, 0.0, -50.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.InstanceFromBooleanMerge(domain=GEOMETRY, 
        instances=(mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-1-1'], 
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-2-1']), 
        keepIntersections=ON, name='Part-3', originalInstances=SUPPRESS)
    mdb.models['Model-'+str(jjj)].parts['Part-3'].Set(cells=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].cells.getSequenceFromMask(('[#2 ]', 
        ), ), name='Set-1')
    mdb.models['Model-'+str(jjj)].parts['Part-3'].SectionAssignment(offset=0.0, 
        offsetField='', offsetType=MIDDLE_SURFACE, region=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].sets['Set-1'], sectionName=
        'Matrixsection', thicknessAssignment=FROM_SECTION)
    mdb.models['Model-'+str(jjj)].parts['Part-3'].Set(cells=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].cells.getSequenceFromMask(('[#1 ]', 
        ), ), name='Set-2')
    mdb.models['Model-'+str(jjj)].parts['Part-3'].SectionAssignment(offset=0.0, 
        offsetField='', offsetType=MIDDLE_SURFACE, region=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].sets['Set-2'], sectionName=
        'Fibersection', thicknessAssignment=FROM_SECTION)
    #Orientation
    mdb.models['Model-'+str(jjj)].parts['Part-3'].MaterialOrientation(
        additionalRotationType=ROTATION_NONE, axis=AXIS_1, fieldName='', localCsys=
        None, orientationType=GLOBAL, region=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].sets['Set-1'], stackDirection=
        STACK_3)
    mdb.models['Model-'+str(jjj)].parts['Part-3'].MaterialOrientation(
        additionalRotationType=ROTATION_NONE, axis=AXIS_1, fieldName='', localCsys=
        None, orientationType=GLOBAL, region=
        mdb.models['Model-'+str(jjj)].parts['Part-3'].sets['Set-2'], stackDirection=
        STACK_3)

    #Creating Reference Points
    mdb.models['Model-'+str(jjj)].rootAssembly.regenerate()
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(-60.0, -60.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(60.0, 60.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(-60.0, 0.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(60.0, 0.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(0.0, 60.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(0.0, -60.0, 0.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(0.0, 0.0, 60.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(0.0, 0.0, -60.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.ReferencePoint(point=(-60.0, -60.0, -60.0))
    mdb.models['Model-'+str(jjj)].rootAssembly.Set(name='ReferenceSet', referencePoints=(
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[8], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[9], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[10], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[11], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[12], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[13], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[14], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[15], 
        mdb.models['Model-'+str(jjj)].rootAssembly.referencePoints[16]))
    # Save by Neelam Mishra on 2020_02_06-13.53.05; build 2016 2015_09_25-02.01.09 126547

    mdb.models['Model-'+str(jjj)].rootAssembly.makeIndependent(instances=(
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-3-1'], ))
    mdb.models['Model-'+str(jjj)].rootAssembly.setMeshControls(elemShape=TET, regions=
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-3-1'].cells.getSequenceFromMask(
        ('[#3 ]', ), ), technique=FREE)
    mdb.models['Model-'+str(jjj)].rootAssembly.setElementType(elemTypes=(ElemType(
    ...
    mdb.models['Model-'+str(jjj)].rootAssembly.setElementType(elemTypes=(ElemType(
        ...
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-3-1'].cells.getSequenceFromMask(
        ('[#3 ]', ), ), ))
    mdb.models['Model-'+str(jjj)].rootAssembly.seedPartInstance(deviationFactor=0.1, 
        minSizeFactor=0.1, regions=(
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-3-1'], ), size=mesh_size)

    mdb.models['Model-'+str(jjj)].rootAssembly.generateMesh(regions=(
        mdb.models['Model-'+str(jjj)].rootAssembly.instances['Part-3-1'], ))
    
    # Display the meshed beam.
    myViewport= session.Viewport(name='neelam'+str(jjj),
    ...
    # Save by Neelam Mishra on 2020_02_06-13.59.42; build 2016 2015_09_25-02.01.09 126547
    ...
    for i in range(len(Set_XP)):
        ...
        for j in range(len(Set_XM)):
            coord_X_XM= Noeuds[Set_XM[i]].coordinates[0]
    ...
    for i in range(len(Set_YP)): 
        ...
        for j in range(len(Set_YM)):
            ...
            coord_Y_YM= Noeuds[Set_YM[i]].coordinates[1]
    ...
    for i in range(len(Set_ZP)):
        ...
        for j in range(len(Set_ZM)):
            ...
            coord_Z_ZM= Noeuds[Set_ZM[i]].coordinates[2]
    ...
    for i in range(len(Set_S)):
        ...
        for j in range(len(Set_R)):
            coord_X_R= Noeuds[Set_R[i]].coordinates[0]
    ...
    for i in range(len(Set_W)):
        ...
        for j in range(len(Set_V)):
            coord_X_V= Noeuds[Set_V[i]].coordinates[0]
    ...
    for i in range(len(Set_CC)):
        ...
        for j in range(len(Set_C)):
            ...
            Wy = coord_Y_CC - coord_Y_D
            Wz = coord_Z_CC - coord_Z_D
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Elec3
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Elec3_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-Elec3'
    ...
    f1=open('Stress_BC_Elec3_volFrac_'+nn+'.txt','w')
    ...
    #rint 'average stress13=' , avg_stress13
    #print 'average stress23=' , avg_stress23

    f1.write('\n volume average stress11 = %20.20f' %avg_stress11)
    f1.write('\n volume average stress22 = %20.20f' %avg_stress22)
    f1.write('\n volume average stress33 = %20.20f' %avg_stress33)
    f1.write('\n volume average stress12 = %20.20f' %avg_stress12)
    f1.write('\n volume average stress13 = %20.20f' %avg_stress13)
    f1.write('\n volume average stress23 = %20.20f' %avg_stress23)
    f1.close()


    f2=open('Strain_BC_Elec3_volFrac_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f2.write('\n volume average strain11 = %20.20f' %avg_strain11)
    f2.write('\n volume average strain22 = %20.20f' %avg_strain22)
    f2.write('\n volume average strain33 = %20.20f' %avg_strain33)
    f2.write('\n volume average strain12 = %20.20f' %avg_strain12)
    f2.write('\n volume average strain13 = %20.20f' %avg_strain13)
    f2.write('\n volume average strain23 = %20.20f' %avg_strain23)
    f2.close()

    f3=open('Electric_Displacement_BC_Elec3_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_Elec3_volFrac_'+nn+'.txt','w')
    ...
    k33=avg_elec_disp3/avg_elec_pot_grad3
    relative_k33=k33/(8.85418782*10**-12)
    e31=-avg_stress11/avg_elec_pot_grad3
    e32=-avg_stress22/avg_elec_pot_grad3
    e33=-avg_stress33/avg_elec_pot_grad3

    
     
    file.write('%4.5f \t  %20.20f \t%20.20f \t %20.20f \t  %20.20f\n '%(vol_frac,e31,e32,e33,relative_k33))
