...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_Elec1_sphere.txt','w')
file.write('vol_frac\t e15\t rel_k11\n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    # Applying Boundary Conditions through Reference Points...............BC-Elec1
    ...
    JobName = 'single_sphere_RVE_PDMS_PMNPT_BC_Elec1_'+ nn
    ...
    print 'Post-processing of Results for Model-'+str(jjj)+' BC-Elec1'
    ...
    f1=open('Stress_BC_Elec1_volFrac_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_Elec1_volFrac_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f3=open('Electric_Displacement_BC_Elec1_volFrac_'+nn+'.txt','w')
    ...
    f4=open('Electric_Potential_Gradient_BC_Elec1_volFrac_'+nn+'.txt','w')
    ...
    k11=avg_elec_disp1/avg_elec_pot_grad1
    relative_k11=k11/(8.85418782*10**-12)
    e15=-avg_stress13/avg_elec_pot_grad1

    
    
    file.write('%4.5f \t  %20.20f \t %20.20f\n '%(vol_frac,e15,relative_k11))
