...
vf_length=len(vf)
mesh_size = 6
file=open('Result_multiparticle_mixed_AR_ESO_BT_PANI_50nm_Elec1.txt','w')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):
   ...
   #AR_1.0 
    ...
    # Saved by Kabir Baidya 11/08/2022
...
#        mask=('[#7 ]', ), )), stackDirection=STACK_3)
    ...
    JobName = 'multiparticle_RVE_ESO_BT_PANI_50nm_Elec1_'+ nn
