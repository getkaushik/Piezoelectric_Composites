...
#The interphase properties aare average of matrix and reinforcement
...
vf_length=len(vf)
mesh_size = 6
file=open('Result_BC_E11_sphere_interphase.txt','w')
file.write('Vol_Frac \t Radius\t Interphase_thickness\t C11\t C12\t C13\t C14\t C15\t C16 \n')
...
for vol_frac,jjj in zip(vf,range(1,vf_length+1)):   
    ...
    mdb.models[ModelName].sketches['__profile__'].Line(point1=(0.0, radius), point2=(
        0.0, -radius))
    ...
    mdb.models[ModelName].sketches['__profile__'].autoTrimCurve(curve1=
        mdb.models[ModelName].sketches['__profile__'].geometry[3], point1=(
        -18.1069564819336, -9.94033622741699))
    mdb.models[ModelName].Part(dimensionality=THREE_D, name='Reinforcement', type=
        DEFORMABLE_BODY)
    mdb.models[ModelName].parts['Reinforcement'].BaseSolidRevolve(angle=360.0, 
    ...
    mdb.models[ModelName].sketches['__profile__'].FixedConstraint(entity=
        mdb.models[ModelName].sketches['__profile__'].geometry[2])
    mdb.models[ModelName].sketches['__profile__'].CircleByCenterPerimeter(center=(
        0.0, 0.0), point1=(radius+thick, 0.0))
    mdb.models[ModelName].sketches['__profile__'].Line(point1=(0.0, radius+thick), point2=(
        0.0, -(radius+thick)))
    mdb.models[ModelName].sketches['__profile__'].VerticalConstraint(addUndoState=
        False, entity=mdb.models[ModelName].sketches['__profile__'].geometry[4])
    mdb.models[ModelName].sketches['__profile__'].autoTrimCurve(curve1=
        mdb.models[ModelName].sketches['__profile__'].geometry[3], point1=(
        -12.265998840332, -17.1241054534912))
    mdb.models[ModelName].Part(dimensionality=THREE_D, name='Interphase', type=
        DEFORMABLE_BODY)
    mdb.models[ModelName].parts['Interphase'].BaseSolidRevolve(angle=360.0, 
        flipRevolveDirection=OFF, sketch=
        mdb.models[ModelName].sketches['__profile__'])
    del mdb.models[ModelName].sketches['__profile__']
# Save by Neelam on 2020_10_22-15.39.47; build 2017 2016_09_28-03.24.59 126836
    ...
    ## Interphase Material (weaker interphase 0.3E_matrix,nu_matrix)
    # Stiffness Matrix of interphase in the absence of applied electric field
    
    C_11 = 7.3771*(10**5)  # Units Pa
    C_12 = 2.4590*(10**5)  # Units Pa
    C_13 = 2.4590*(10**5)  # Units Pa
    C_14 = 0 # Units Pa
    C_15 = 0 # Units Pa
    C_16 = 0 # Units Pa
    C_22 = 7.3771*(10**5)  # Units Pa
    C_23 = 2.4590*(10**5)  # Units Pa
    C_24 = 0 # Units Pa
    C_25 = 0 # Units Pa
    C_26 = 0 # Units Pa
    C_33 = 7.3771*(10**5) # Units Pa
    C_34 = 0 # Units Pa
    C_35 = 0 # Units Pa
    C_36 = 0 # Units Pa
    C_44 = 2.4590*(10**5)  # Units Pa
    C_45 = 0 # Units Pa
    C_46 = 0 # Units Pa
    C_55 = 2.4590*(10**5)  # Units Pa
    C_56 = 0 # Units Pa
    C_66 = 2.4590*(10**5)  # Units Pa
    # Piezoelectric stress-coefficient matrix
    e_11 = 0 # Units C/(m**2)
    e_12 = 0 # Units C/(m**2)
    e_13 = 0 # Units C/(m**2)
    ...
    K_11 = K_m11 # Units F/m
    K_12 = 0 # Units C/(V.m)
    K_13 = 0 # Units C/(V.m)
    K_22 = K_m22 # Units F/m
    K_23 = 0 # Units C/(V.m)
    K_33 = K_m33 # Units F/m
    ...
    mdb.models[ModelName].Material(name='PDMS')
    mdb.models[ModelName].materials['PDMS'].Piezoelectric(table=((e_m11, e_m12, e_m13, e_m16, e_m15, e_m14, e_m21, e_m22, e_m23, e_m26, e_m25, e_m24, e_m31, e_m32, e_m33, e_m36, e_m35, e_m34), ))
    mdb.models[ModelName].materials['PDMS'].Elastic(type=ANISOTROPIC, table=((C_m11, C_m12, C_m22, C_m13, C_m23, C_m33, C_m16, C_m26, C_m36, C_m66, C_f15, C_f25, C_m35, C_m56, C_m55, C_m14, C_m24, C_m34, C_m46, C_m45, C_m44), ))
    mdb.models[ModelName].materials['PDMS'].Dielectric(type=ANISOTROPIC, table=((K_m11, K_m12, K_m22, K_m13, K_m23, K_m33), ))
    mdb.models[ModelName].Material(name='PMNPT')
    mdb.models[ModelName].materials['PMNPT'].Piezoelectric(table=((e_f11, e_f12, e_f13, e_f16, e_f15, e_f14, e_f21, e_f22, e_f23, e_f26, e_f25, e_f24, e_f31, e_f32, e_f33, e_f36, e_f35, e_f34), ))
    mdb.models[ModelName].materials['PMNPT'].Elastic(type=ANISOTROPIC, table=((C_f11, C_f12, C_f22, C_f13, C_f23, C_f33, C_f16, C_f26, C_f36, C_f66, C_f15, C_f25, C_f35, C_f56, C_f55, C_f14, C_f24, C_f34, C_f46, C_f45, C_f44), ))
    mdb.models[ModelName].materials['PMNPT'].Dielectric(type=ANISOTROPIC,table=((K_f11, K_f12, K_f22, K_f13, K_f23, K_f33), ))
    ...
    #create sections
    mdb.models[ModelName].HomogeneousSolidSection(material='PDMS', name=
        'Matrixsection', thickness=None)
    mdb.models[ModelName].HomogeneousSolidSection(material='PMNPT', name=
...
#Create Reference Points
   ...
   ## Set Mesh Control
    ...
    JobName = 'single_sphere_PDMS_PMNPT_BC_E11_interphase_thickness_'+ nn
    ...
    f1=open('Stress_BC_E11_Interphase_Thickness_'+nn+'.txt','w')
    ...
    f2=open('Strain_BC_E11_Interphase_Thickness_'+nn+'.txt','w')
   ...
   # print 'average strain22=' , avg_strain22
    ...
    f3=open('Electric_Displacement_BC_E11_Interphase_Thickness_'+nn+'.txt','w')
    ...
    f3.write('\n volume average electricdisplacement1 = %20.8f' %avg_elec_disp1)
    f3.write('\n volume average electricdisplacement2 = %20.8f' %avg_elec_disp2)
    f3.write('\n volume average electricdisplacement3 = %20.8f' %avg_elec_disp3)

    f3.close()

    f4=open('Electric_Potential_Gradient_BC_E11_Interphase_Thickness_'+nn+'.txt','w')
    ...
    file.write('%4.5f %4.5f %4.5f \t %20.5f \t %20.5f \t%20.5f \t %20.5f \t %20.5f \t  %20.5f\n '%(vol_frac,radius,thick,C11,C12,C13,C14,C15,C16))
